...
//object Function{ 기존 옵젝 선언 위치
  ...
  // def recResult(std_NO:Int, user_trust_df:(DataFrame, DataFrame), user_sim_df: (DataFrame, DataFrame)): DataFrame ={



  // val user_sim_df_temp1 = calSim(spark, 20152611)
  val user_sim_DF = user_sim_df.drop("sbjt_similarity", "ncr_similarity", "acting_similarity")
  //
  //
  // val std_no = 20152611
  // var i = INTEREST(std_no)
  // val user_trust_df = TRUST(i._1, i._2, i._3)
...
object Main{
  def main(args:Array[String]):Unit={
    ...
    // recResult(std_no, t, c, i._1, i._2, i._3)
    var r = recResult(std_no, t, c, i._1, i._2, i._3)._1.toList
